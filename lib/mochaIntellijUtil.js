...
function requireBaseReporter() {
  ...
  try {
    ...
    if (typeof Base !== 'function') {
      Base = null;
      console.error('mocha-intellij: base reporter (' + baseReporterPath + ') is expected to be a function.');
    }
  } catch (e) {
    console.error('mocha-intellij: cannot load base reporter from ' + baseReporterPath, e);
  }
  return Base;
}
